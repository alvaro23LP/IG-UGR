...
float dCamara = 0, xCamara=0, zCamara=0;
...
void letra (unsigned char k, int x, int y)
{
  ...
  switch (k)
  {
    ...
    //std::cout << xCamara << " " << zCamara << " " << " "  << rotxCamara << " " << rotyCamara << std::endl;
  setCamara (rotxCamara, rotyCamara, dCamara, xCamara, zCamara, cambioPos);
  xCamara = zCamara = 0;
